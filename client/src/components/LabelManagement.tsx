...
import { Plus, Trash2, Tag, Edit2, FolderOpen, Loader2, Globe, Lock, AlertTriangle, Search, MoreHorizontal } from 'lucide-react';
...
export function LabelManagement({ open, onClose }: LabelManagementProps) {
  ...
  const filteredLabels = labels.filter(label => {
    ...
    const matchesGlobal = filterGlobal === 'all' || (filterGlobal === 'global' && label.isGlobal) || (filterGlobal === 'local' && !label.isGlobal);
                  ...
                  <div className="h-full flex flex-col">
                    ...
                    <div className="px-6 py-4 border-b bg-gray-50/50">
                      <div className="flex items-center gap-3">
                        ...
                        <Button size="sm" onClick={() => setIsAddLabelOpen(true)} disabled={isLoading}>
                      ...
                      {filteredLabels.length > 0 && (
                        <div className="flex items-center gap-3 mt-3 pt-3 border-t">
                          <Checkbox
                            checked={selectedLabelIds.length === filteredLabels.length && filteredLabels.length > 0}
                    ...
                    <div className="flex-1 overflow-auto px-6 py-4">
                      {filteredLabels.length > 0 ? (
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="flex items-center gap-2 mt-1 text-xs text-gray-500">
                                    ...
                                    {label.creator && (
                                      <span>by {label.creator.fullName || label.creator.email}</span>
                                    )}
                                    {label._count?.projectLabels !== undefined && label._count.projectLabels > 0 && (
                                      <>
                                        <span>•</span>
                                        <span>{label._count.projectLabels} project{label._count.projectLabels !== 1 ? 's' : ''}</span>
                                      </>
                                    )}
                                  </div>
                                </div>
                        ...
                        <div className="flex flex-col items-center justify-center h-64 text-gray-500">
                          ...
                          <p className="text-sm mt-1">Create a new label to get started</p>
                          <Button className="mt-4" size="sm" onClick={() => setIsAddLabelOpen(true)}>
                            <Plus className="w-4 h-4 mr-1" />
                            Create Label
                          </Button>
                        </div>
                ...
                {view === 'categories' && (
                  <div className="h-full flex flex-col">
                    ...
                    <div className="px-6 py-4 border-b bg-gray-50/50 flex justify-between items-center">
                      ...
                      <Button size="sm" onClick={() => setIsAddCategoryOpen(true)} disabled={isLoading}>
                        <Plus className="w-4 h-4 mr-1" />
                        New Category
                      </Button>
                    </div>
                    ...
                    <div className="flex-1 overflow-auto px-6 py-4">
                      {categories.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-64 text-gray-500">
                          ...
                          <Button className="mt-4" size="sm" onClick={() => setIsAddCategoryOpen(true)}>
                            <Plus className="w-4 h-4 mr-1" />
                            Create Category
                          </Button>
                        </div>
