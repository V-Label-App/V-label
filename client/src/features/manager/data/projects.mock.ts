import type {
  LegacyLabel as LabelType,
  LegacyLabelCategory as LabelCategory,
...
export const initialLabels: LabelType[] = [
  // Medical Category
  {
    ...
    color: "#EF4444",
    category: "medical",
    description: "Tumor or lesion detection",
  ...
  },
  {
    ...
    color: "#10B981",
    category: "medical",
    description: "Organ segmentation",
    createdAt: "2026-01-10",
  },
  // Animals Category
  {
  ...
  },
  {
    ...
    color: "#F97316",
    category: "vehicles",
    description: "Motorcycle detection",
    createdAt: "2026-01-12",
  },
];
...
export const initialCategories: LabelCategory[] = [
  ...
  },
  {
    id: "animals",
    name: "Animals",
    description: "Animal and wildlife detection",
    color: "#3B82F6",
  },
  {
    id: "vehicles",
    name: "Vehicles",
    description: "Vehicle and transportation objects",
    color: "#06B6D4",
  },
];
