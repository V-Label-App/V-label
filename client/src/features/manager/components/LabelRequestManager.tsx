...
export function LabelRequestManager({
  ...
  // Action States
  const [selectedRequest, setSelectedRequest] = useState<LabelRequest | null>(
    null,
  );
  ...
  const fetchRequests = async () => {
    setIsLoading(true);
    try {
      const data = await labelRequestApi.getProjectRequests(
        projectId,
        activeTab,
      );
      setRequests(data);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Manage label requests from annotators.
          </p>
        </div>
        <Button
          variant="outline"
              ...
              {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-sm text-gray-500 max-w-sm mt-1">
                    There are no {activeTab.toLowerCase()} label requests in
                    this project.
                  </p>
                </div>
              ) : (
      ...
      <Dialog open={isApproveOpen} onOpenChange={setIsApproveOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Create the label <strong>{selectedRequest?.labelName}</strong> and
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <strong>{selectedRequest?.labelName}</strong>. This action cannot
              be undone.
            </DialogDescription>
          </DialogHeader>
